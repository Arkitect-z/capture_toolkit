...
def process_tactile_data(configs):
    """
    Main function to run the batch processing of tactile .csv files based on provided configurations.
    Includes a final summary report of any errors.

    Args:
        configs (list[TactileConfiguration]): A list of configuration objects to process.
    """
    # --- Initialization ---
    failed_files = []
...
if __name__ == "__main__":
    ...
    if not csv_files:
        ...
        process_tactile_data(configurations)
