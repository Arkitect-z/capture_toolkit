...
def get_smplx_model(model_type="smpl", gender="neutral"):
    ...
    # FIX: Explicitly set the number of shape and expression parameters for smplx.
    # This ensures the model is initialized with the correct matrix sizes.
    if model_type == 'smplx':
        extra_params['num_betas'] = 16
        extra_params['num_expression_coeffs'] = 10
